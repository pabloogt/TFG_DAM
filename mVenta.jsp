...
<%
          ...
          ResultSet listado = s.executeQuery ("SELECT id_cliente FROM clientes");
          
          Class.forName("com.mysql.jdbc.Driver");
           conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/empresa","root", "pablito12");
           s = conexion.createStatement();
           ResultSet listado2 = s.executeQuery ("SELECT Nombre FROM clientes");
      ...
      <div class="panel panel-info">
        ...
        <div class="panel panel-info panel-heading text-center azul">Cabecera - Ventas</div>
          
          <form method="get" action="grabaVenta.jsp">
            <div class="form-group"> 
              <label>&nbsp;&nbsp;ID Ventas:&nbsp;</label><input type="text" size="5" name="ID_Ventas" value="1">
              <label>&nbsp;&nbsp;Nº de factura:&nbsp;</label><input type="text" size="5" name="N_Factura" value="34">
            </div>
            <div class="form-group">
           
             <label>&nbsp;&nbsp;Código de clientes:&nbsp;</label>
             <select name="Codigo_clientes" >
				        <%
				            while (listado.next()) {
				                out.println("<option>" + listado.getInt("id_cliente") + "</option>");
				            }
				        %>
				    </select>
             <label>&nbsp;&nbsp;Nombre de clientes:&nbsp;</label>
              <select name="Nombre_clientes" >
				        <%
				            while (listado2.next()) {
        ...
        <div class="panel panel-info panel-heading text-center azul">Detalles - Ventas</div>
          
            <div class="form-group"> 
              <label>&nbsp;&nbsp;Nº de línea:&nbsp;</label><input type="text" size="20" name="N_Linea" value="Mismo id que id_Ventas" readonly>
            </div>
            <div class="form-group">
            ...
            <hr>
            &nbsp;&nbsp;<a href="indexV.jsp" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>Cancelar</a>
